...
def getMeanModel(models:list) -> xarray.DataArray:
    """
    Parameters
    ----------
    models : list of data arrays
...
def getDataOnRegion(data:xarray.DataArray, shapefile:geopandas.GeoDataFrame):
    ...
    # https://www.guillaumedueymes.com/post/shapefiles_country/ <----- Got code from here, ask about citing code from websites
...
# data = getMeanModel(getModelsFromNetCDF("/home/persad_users/csc3323/masking_shapefiles/pr_anntot_RCP85.nc"))
# shapefile = geopandas.read_file("/home/persad_users/csc3323/masking_shapefiles/CA_Bulletin_118_Groundwater_Basins.shp")

# outputFigureOfRegion(data, shapefile, "out.png")
